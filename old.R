...
## 上場年が2018年以降の企業 ##
corp <- c('日本国土開発','ヤマエ久野','クワザワホールディングス','丸順','表示灯','木村工機','ソフトバンク','竹田印刷','オーウエル','オリエンタル白石','清鋼材','紀文食品','国際紙パルプ商事','ワシントンホテル','ローランド','日本インシュレーション','イーソル','ヤシマキザイ','オーケーエム','恵和','神戸天然物化学','シーズクリエイト',
          '未来工業','日創プロニティ','Ｌｉｂ　Ｗｏｒｋ','エコモット','ｇｌｏｂａｌ　ｂｒｉｄｇｅ　Ｈ','技研ホールディングス','ＣＲＥロジスティクスファンド投','ザイマックス・リート投資法人','Ｍマート','ＳＥＲＩＯホールディングス','日総工産','フェイスネットワーク','信和','バリュエンスホールディングス','ファイバーゲート','ＲＰＡホールディングス','和心','日本リビング保証','ブティックス','ビープラッツ','コンヴァノ','ヒューマン・アソシエイツ・ホー',
          'ベストワンドットコム','エヌリンクス','揚工舎','ビズライト・テクノロジー','ひかりホールディングス','ログリー','ＳＩＧグループ','コーア商事ホールディングス','ＺＵＵ','ライトアップ','エーアイ','アイ・ピー・エス','スプリックス','インバウンドテック','ＭＴＧ','ロジザード','ＦＩＧ','キャンディル','マネジメントソリューションズ','バンク・オブ・イノベーション','ＧＡ　ｔｅｃｈｎｏｌｏｇｉｅｓ','エクスモーション','プロレド・パートナーズ',
          'アクリート','タカラレーベン不動産投資法人','システムサポート','フロンティア','チームスピリット','ａｎｄ　ｆａｃｔｏｒｙ','伊藤忠アドバンス・ロジスティク','ナルミヤ・インターナショナル','アズーム','テノ．ホールディングス','イーエムネットジャパン','東京インフラ・エネルギー投資法','フロンティア・マネジメント','アザース','ＩＴｂｏｏｋホールディングス','スペースバリューホールディング','ダイヤモンドエレクトリックホー','くふう中間持株会社',
          'ベルテクスコーポレーション','ブックオフグループホールディン','ＣＲＧホールディングス','Ｄｅｌｔａ−Ｆｌｙ　Ｐｈａｒｍ','ギフト','ＬｅＴｅｃｈ','ＶＡＬＵＥＮＥＸ','霞ヶ関キャピタル','アルー','ピアラ','筑波精工','テクノスデータサイエンス・エン','Ａｍａｚｉａ','Ｋｕｄａｎ','ポート','ＡＣＳＬ','ＥｄｕＬａｂ','ベルトラ','シノプス','パスロジ','エスコンジャパンリート投資法人','エネクス・インフラ投資法人','識学','リックソフト','東海ソフト',
          'フロンティアインターナショナル','スマレジ','ヒト・コミュニケーションズ・ホ','ダイコー通産','サーバーワークス','サンケイリアルエステート投資法','タカネットサービス','カオナビ','コプロ・ホールディングス','ミンカブ・ジ・インフォノイド','ギークス','マルク','ｇｏｏｄｄａｙｓホールディング','ＮＡＴＴＹ　ＳＷＡＮＫＹ','フレアス','日本ホスピスホールディングス','Ｂｉｒｄｍａｎ','Ｗｅｌｂｙ','ヴィッツ','ハウテレビジョン','グッドスピード',
          'トビラシステムズ','バルテス','スター・マイカ・ホールディング','ユーピーアール','ピアズ','ブランディングテクノロジー','インフォネット','リビン・テクノロジーズ','ＳＴＧ','Ｌｉｎｋ−Ｕ','ビーアンドピー','ブシロード','ツクルバ','ステムリム','Ｌｉｖ−ｕｐ','薬王堂ホールディングス','サイバー・バズ','ＨＰＣシステムズ','パワーソリューションズ','レオクラン','Ｋｉｐｓ','ＨＥＮＮＧＥ','軽自動車館','インティメート・マージャー','セルソース',
          'ＢＡＳＥ','ダブルエー','トゥエンティーフォーセブン','ＱＬＳホールディングス','ＳＯＳｉＬＡ物流リート投資法人','ＡＬｉＮＫインターネット','フリー','テクノフレックス','マクアケ','メドレー','ウィルズ','ＪＭＤＣ','ＳＲＥホールディングス','ユナイトアンドグロウ','ランディックス','スペースマーケット','ＩＮＣＬＵＳＩＶＥ','ファンペップ','カクヤスグループ','ＷＤＢココ','ＡＩ　ｉｎｓｉｄｅ','スポーツフィールド','ジモティー',
          'ジャパン・インフラファンド投資','ＡＨＣグループ','Ｋｉｄｓ　Ｓｍｉｌｅ　Ｈｏｌｄ','カーブスホールディングス','きずなホールディングス','ウイルテック','フォースタートアップス','横浜ライト工業','リグア','ミクリード','リビングプラットフォーム','ドラフト','関通','ペルセウスプロテオミクス','ヴィス','アディッシュ','サイバーセキュリティクラウド','バリオセキュア','Ｍａｃｂｅｅ　Ｐｌａｎｅｔ','コパ・コーポレーション',
          'ＡＤワークスグループ','松屋アールアンドディ','ロコガイド','コマースＯｎｅホールディングス','アールプランナー','さくらさくプラス','ＧＭＯフィナンシャルゲート','エージェント','カレント自動車','Ｃ　Ｃｈａｎｎｅｌ','ファーストステージ','フィーチャ','グッドパッチ','Ｂｒａｎｄｉｎｇ　Ｅｎｇｉｎｅ','ＫＩＹＯラーニング','日本情報クリエイト','Ｓｕｎ　Ａｓｔｅｒｉｓｋ','モダリス','ティアンドエス','ニューラルポケット','インターファクトリー',
          '雪国まいたけ','トヨクモ','ＳＴＩフードホールディングス','ｒａｋｕｍｏ','ヘッドウォータース','アクシス','タスキ','ダイレクトマーケティングミック','勤次郎','カラダノート','プレミアアンチエイジング','Ｒｅｔｔｙ','アートフォースジャパン','一寸房','アララ','クリーマ','北海道歯科産業','スタメン','バルミューダ','ビートレンド','プレイド','ココペリ','ヤプリ','ポピンズホールディングス','いつも','ウェルスナビ','Ｋａｉｚｅｎ　Ｐｌａｔｆｏｒｍ',
          '東京通信','Ｇｅｏｌｏｃａｔｉｏｎ　Ｔｅｃ','クリングルファーマ','オンデック','ＱＤレーザ','アクシージア','ｃｏｌｙ','ジェイベース','ヒューマンクリエイションホール','ココナラ','ｉ−ｐｌｕｇ','Ｔ．Ｓ．Ｉ','Ｓｈａｒｉｎｇ　Ｉｎｎｏｖａｔ','ベビーカレンダー','ブロードマインド','ジーネクスト','スパイダープラス','Ａｐｐｉｅｒ　Ｇｒｏｕｐ','ＬＩＴＡＬＩＣＯ','アイ・パートナーズフィナンシャ','ジェイ・イー・ティ','琉球アスティーダスポーツクラブ',
          'ビジョナル','ステラファーマ','テスホールディングス','メイホーホールディングス','ワンダープラネット','Ｅｎｊｉｎ','全研本社','デコルテ・ホールディングス','ペイロール','アイドマ・ホールディングス','セレンディップ・ホールディング','ベイシス','日本電解','ＢｌｕｅＭｅｍｅ','Ｗａｑｏｏ','プラスアルファ・コンサルティン','ＢＣＣ','コラントッテ','オージックグループ','アシロ','サーキュレーション','ブレインズテクノロジー','ＡＩメカテック',
          'デリバリーコンサルティング','アーバンライク','イヴレス','ジェイック','ビーイングホールディングス','フォーラムエンジニアリング','ワールド','ブリッジインターナショナル','バルコス','ミダックホールディングス','ＫＨＣ','ウイングアーク１ｓｔ','リバーホールディングス','ＪＴＯＷＥＲ','アジャイルメディア・ネットワー','ステムセル研究所','ＮｅｘＴｏｎｅ','かっこ','ＨＥＲＯＺ','ＷＡＣＵＬ','アルテリア・ネットワークス','ＡＩ　ＣＲＯＳＳ','フィードフォースグループ','ビザスク',
          'ギフティ','Ｃｈａｔｗｏｒｋ','メルカリ','ＢｕｙＳｅｌｌ　Ｔｅｃｈｎｏｌ','ＥＮＥＣＨＡＮＧＥ','アイダ設計','ＳＡＮＥＩ','サイバートラスト','ベース','ラキール','コンフィデンス','Ｉ−ｎｅ','ＡｍｉｄＡホールディングス','共和コーポレーション','アイリックコーポレーション','新日本製薬','ジェイテックコーポレーション','アイキューブドシステムズ','ドリームベッド','Ｆａｓｔ　Ｆｉｔｎｅｓｓ　Ｊａ','キュービーネットホールディング','交換できるくん',
          '東名','アップコン','ラクスル','プロパティデータバンク','オキサイド','ランサーズ','Ｓａｎｓａｎ','オリバー')
